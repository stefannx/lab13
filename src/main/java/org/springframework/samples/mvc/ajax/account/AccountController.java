...
import org.springframework.samples.mvc.ajax.account.AvailabilityStatus;
import org.springframework.samples.mvc.ajax.account.ResourceNotFoundException;
...
public class AccountController
{
   ...
   @Autowired
   public AccountController(Validator validator1)
   {
